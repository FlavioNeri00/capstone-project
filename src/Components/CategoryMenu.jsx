        ...
        <Row className="d-flex justify-content-center gx-5 gy-3">
          <Col xs={12} md={4} lg={3}>
            <Card style={{ height: "15rem", width: "18rem" }}>
              ...
              />
              <Card.Body style={{ backgroundColor: "#F4E7DB" }}>
                <Card.Title>Bevande calde</Card.Title>
                <Card.Text>Caffè, Tè, Cioccolata...</Card.Text>
                <Link to="/:category">
                  <Button className="border border-0 rounded-0" style={{ backgroundColor: "#031635" }}>
                    Vai al menù
                  </Button>
                </Link>
              </Card.Body>
          ...
          <Col xs={12} md={4} lg={3}>
            <Card style={{ height: "15rem", width: "18rem" }}>
              <Card.Img
                style={{ objectFit: "cover", overflow: "hidden", objectPosition: "0 -5rem" }}
                variant="left"
          ...
          <Col xs={12} md={4} lg={3}>
            <Card style={{ height: "15rem", width: "18rem" }}>
              <Card.Img
                style={{ objectFit: "cover", overflow: "hidden", objectPosition: "center -13rem " }}
                variant="left"
