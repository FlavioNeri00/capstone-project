...
const Body = () => {
  return (
    <div className="mb-3 mt-5">
      {/* <h2
          className="display-2 text-center mb-4 fw-bold "
          ...
          <Col xs={12} lg={4}>
            ...
            >
              <Card.Body className="d-flex flex-column justify-content-between">
                <Card.Title
                  className="title-myriad"
                  style={{ color: "#F4E7DB" }}
                >
                  Scaro Cafè
                </Card.Title>
                <Card.Text
                  className="text-start parag-arpona"
                  style={{ color: "#F4E7DB" }}
                >
                  Scaro Cafe è il braccio economico di Scaro Project. Un bar
                  sociale con una forte attenzione alla provenienza dei prodotti
                  e alle storie delle aziende e delle persone con cui coopera.
                  Un piccolo spazio che fa da apripista ad un grande progetto.
                </Card.Text>
            ...
            >
              <Card.Body className="d-flex flex-column justify-content-between ">
                ...
                <Card.Text
                  ...
                  style={{ color: "#F4E7DB" }}
                >
                  Scaro Community è il cuore pulsante di Scaro Project. È Il
                  luogo in cui progettare la città che verrà. Il primo spazio
                  autogestito dagli studenti delle scuole superiori, università
                  ed Erasmus. Uno spazio per chi vive il quartiere e Piazza
            ...
            >
              ...
              >
                ...
                <Card.Text className="text-start parag-arpona">
                  Scaro Market è la riproposizione dello scaro in chiave
                  moderna. È un luogo per fiere di artigianato locale ma anche
                  etnico. Scaro Market è il punto di incontro tra culture
                  diverse che abitano lo stesso spazio.
                </Card.Text>
                <Button
                  style={{
                    maxWidth: "10rem",
      ...
      <Container className="text-center" fluid="lg">
        ...
        >
          ...
          PROGETTO DI{" "}
          <span style={{ color: "#F2B708" }}>RIQUALIFICAZIONE URBANA</span> AD
          AGRIGENTO"
        </h2>
      </Container>
    </div>
